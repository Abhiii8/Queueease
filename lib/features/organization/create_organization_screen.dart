...
class _CreateOrganizationScreenState extends ConsumerState<CreateOrganizationScreen> {
  ...
  bool _enableScheduledAppointments = false;
  ...
  Future<void> _submit() async {
    ...
    try {
      var uri = Uri.parse('${ApiClient.baseUrl}/organizations/create.php');
      var request = http.MultipartRequest('POST', uri);
      
      request.fields['name'] = _nameController.text.trim();
      request.fields['category'] = _selectedCategory;
      request.fields['description'] = _descController.text.trim();
      request.fields['branch_name'] = _branchController.text.trim();
      ...
      if (response.statusCode == 201) {
        ...
        // Instantly sync new token and role
        if (data['jwt'] != null && data['user'] != null) {
          await ref.read(authProvider.notifier).updateToken(data['jwt'], data['user']);
        }

        // Refresh the organizations list on the Home Screen
        ...
        final data = jsonDecode(response.body);
        _showError(data['message'] ?? 'Failed to create organization');
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Register Business', style: TextStyle(fontWeight: FontWeight.w900, color: Color(0xFF0F172A))),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Fill out the details below to add your business to QueueEase and let customers join your queue remotely.',
                  ...
                  const Center(
                    child: Text('Tap to add logo', style: TextStyle(color: AppColors.textSecondary, fontSize: 13, fontWeight: FontWeight.w600)),
                  ),
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildInput(
                          ...
                          hint: 'e.g. Main Branch, Downtown Clinic',
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      child: _isLoading 
                          ...
                          : const Text('REGISTER BUSINESS', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, letterSpacing: 1.5, color: Colors.white)),
                    ),
                  ),
                ],
              ),
